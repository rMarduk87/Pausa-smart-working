                    ...
                    lines.drop(1).forEach { riga ->
                        ...
                        if (colonne.size >= 9) {
                            ...
                            val newAchievement = Achievement(
                                ...
                                earned = existing?.earned == 1 || colonne[7].cleanValue()
                                    .equals("True", ignoreCase = true),
                                date = existing?.date ?: colonne[8].cleanValue()
